...
if __name__ == "__main__":
    ...
    #raw_data = sc.textFile('/user/zp489/reddit_sarcasm_small.txt')
    ...
    filtered_rdds.append(filtered_length)
    data = length_inter1 \
    ...
    for ngram_n in N_GRAMS:
        ...
        logprob_cutoff = logprob_df.stat.approxQuantile("logprob", [LOGPROB_QUANTILE_CUTOFF], 0.001)[0]
